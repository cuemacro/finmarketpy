...
from findatapy.timeseries import Calculations, Calendar  # noqa: E402
...
if run_example == 1 or run_example == 0:
    ...
    interpolated_forwards_df = fx_forwards_price.price_instrument(
        cross, market_df.index, delivery_dates, market_df=market_df, fx_forwards_tenor_for_interpolation=["1W", "2W"]
    )
...
if run_example == 2 or run_example == 0:
    ...
    implied_depo_df = fx_forwards_price.calculate_implied_depo(
        cross, "AUD", market_df=market_df, fx_forwards_tenor=fx_forwards_tenors, depo_tenor="1M"
    )
