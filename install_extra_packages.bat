...
pip install numpy, pandas, pytz, request, multiprocessing_on_dill, pandas_datareader, quandl, redis, openpxyl, blosc, bokeh, plotly, cufflinks, matplotlib, git+https://github.com/manahl/arctic.git
