"""Module for trade analysis of backtested trading strategies."""
...
class TradeAnalysis:
    """Apply basic trade analysis for a trading strategy.

    Uses PyFolio to create basic trading statistics. Also allows testing multiple
    parameters for a specific strategy (like TC).
    """

    def __init__(self, engine=None):
        """Initialise TradeAnalysis with the given chart engine."""
        if engine is None:
    ...
    def save_positions_trades(self, tm, signals, trades, signal_caption, trade_caption, writer):
        """Save position and trade data to Excel sheets."""
