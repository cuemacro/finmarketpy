...
class BacktestRequest(MarketDataRequest):
    ...
    def __init__(self):
        ...
        # output parameters for backtest (should we add returns statistics on
        # legends, write CSVs with returns etc.)
        ...
        # by default apply max position criterion on last business day of month
        ...
        # annualization factor for return stats (and should we resample data
        # first before calculating it?)
