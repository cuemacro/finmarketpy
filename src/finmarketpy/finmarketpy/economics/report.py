...
class Report:
    ...
    def report_single_var_regression(self, y, x, y_variable_names, x_variable_names, statistic, pretty_index=None):  # noqa: D102
    ...
    def plot_single_var_regression(  # noqa: D102
        self,
        y,
        x,
        y_variable_names,
