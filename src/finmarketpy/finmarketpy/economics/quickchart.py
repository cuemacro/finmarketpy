...
class QuickChart:
    ...
    def __init__(self, engine="plotly", data_source="bloomberg", market_data_generator=MarketDataGenerator()):  # noqa: B008, D107
        self._chart = Chart(engine=engine)
        self._market = Market(market_data_generator=market_data_generator)
        self._data_source = data_source

    def plot_chart(  # noqa: D102
        self,
        tickers=None,
        tickers_rhs=None,
        start_date=None,
        ...
        style = Style(
            ...
            height=height,
            width=width,
            file_output=datetime.date.today().strftime("%Y%m%d") + " " + title + ".png",
    ...
    def plot_chart_with_ret_stats(  # noqa: D102
        self,
        df=None,
        chart_file=None,
        chart_type="line",
