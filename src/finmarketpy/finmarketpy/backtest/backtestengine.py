...
class Backtest:
    ...
    def calculate_trading_PnL(  # noqa: N802
        ...
        if br.take_profit is not None and br.stop_loss is not None:
            ...
            #
            #     to_plot = _calculations.pandas_outer_join([asset_df_copy, pre_signal_df, signal_df_copy, trade_rets_df_copy, temp_strategy_rets_df])  # noqa: E501
        ...
        if False:  # market_constants.backtest_thread_no[market_constants.generic_plat] > 1 and run_in_parallel:
            ...
            resultsA = pool.apply_async(calculations.create_mult_index, args=(self._pnl,))  # noqa: N806
            resultsB = pool.apply_async(calculations.create_mult_index, args=(self._components_pnl,))  # noqa: N806
            resultsC = pool.apply_async(calculations.create_mult_index, args=(self._portfolio,))  # noqa: N806
            ...
            if br.cum_index == "mult":
                ...
                # Calculate individual signals cumulative P&L after signal leverage but before portfolio level constraints  # noqa: E501
                self._pnl_cum = calculations.create_add_index(self._pnl)

                # Calculate individual signals cumulative P&L after signal leverage AND after portfolio level constraints  # noqa: E501
    ...
    def backtest_output(self):  # noqa: D102
        return
...
class TradingModel:
        ...
        if market_constants.backtest_thread_no[market_constants.generic_plat] > 1 and run_in_parallel:
            ...
            for key in bask_keys:
                if key != self.FINAL_STRATEGY:
                    ...
                    # Calculate final strategy separately in my main process (so don't have issues with pickling back large output)  # noqa: E501
    ...
    def construct_individual_strategy(
        ...
        # For final strategy return heavyweight backtest object (contains lots of auxilliary information about trades etc)  # noqa: E501
    ...
    def individual_leverage(self) -> pd.DataFrame:  # noqa: D102
        return self._individual_leverage

    def strategy_group_pnl_trades(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_pnl_trades

    ### components (after signal and portfolio weighting)
    def strategy_components_pnl(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_components_pnl

    def strategy_components_pnl_ret_stats(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_components_pnl_ret_stats

    ### Final strategy
    def strategy_pnl(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_pnl

    def strategy_pnl_ret_stats(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_pnl_ret_stats

    def strategy_leverage(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_leverage

    ### Final PNL strategy + benchmark
    def strategy_benchmark_pnl(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_benchmark_pnl

    def strategy_benchmark_pnl_ret_stats(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_benchmark_pnl_ret_stats

    ### Final PNL + group
    def strategy_group_pnl(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_pnl

    def strategy_group_pnl_ret_stats(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_pnl_ret_stats

    ### Final P&L + group + benchmark
    def strategy_group_benchmark_pnl(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_benchmark_pnl

    def strategy_group_benchmark_pnl_ret_stats(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_benchmark_pnl_ret_stats

    def strategy_group_leverage(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_group_leverage

    # Signals
    def strategy_signal(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_signal

    def strategy_trade(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_trade

    def strategy_signal_notional(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_signal_notional

    def strategy_trade_notional(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_trade_notional

    def strategy_trade_notional_sizes(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_trade_notional_sizes

    def strategy_signal_contracts(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_signal_contracts

    def strategy_trade_contracts(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_trade_contracts

    def strategy_total_longs(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_total_longs

    def strategy_total_shorts(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_total_shorts

    def strategy_net_exposure(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_net_exposure

    def strategy_total_exposure(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_total_exposure

    def strategy_total_longs_notional(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_total_longs_notional

    def strategy_total_shorts_notional(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_total_shorts_notional

    def strategy_net_exposure_notional(self) -> pd.DataFrame:  # noqa: D102
        return self._strategy_net_exposure_notional

    def strategy_total_exposure_notional(self) -> pd.DataFrame:  # noqa: D102
    ...
    def plot_individual_leverage(  # noqa: D102
        self,
        strip: str | None = None,
    ...
    def plot_strategy_group_pnl_trades(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_pnl(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_trade_no(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_signal_proportion(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_leverage(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
        ...
        ##### Plot the individual components cumulative returns and return statistics (including portfolio level constraints)  # noqa: E501

    def plot_strategy_components_pnl(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_components_pnl_ir(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_components_pnl_returns(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_components_pnl_vol(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_components_pnl_drawdowns(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_components_pnl_yoy(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
        ...
        ##### this will plot the final strategy, benchmark and all the individual baskets (as though they were run by themselves)  # noqa: E501

    def plot_strategy_group_benchmark_pnl(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_group_benchmark_pnl_ir(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_group_benchmark_pnl_returns(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_group_benchmark_pnl_vol(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_group_benchmark_pnl_drawdowns(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_group_benchmark_pnl_yoy(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_group_leverage(  # noqa: D102
        self,
        silent_plot: bool = False,
        reduce_plot: bool = True,
        resample: str = "B",
    ...
    def plot_strategy_all_signals(  # noqa: D102
        self,
    ...
    def plot_strategy_signals(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_trades(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_signals_notional(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_trades_notional(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_trades_notional_sizes(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        ret_with_df: bool = False,
    ...
    def plot_strategy_signals_contracts(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_trades_contracts(  # noqa: D102
        self,
        date: str | None = None,
        strip: str | None = None,
        silent_plot: bool = False,
    ...
    def plot_strategy_total_exposures(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_net_exposures(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_total_exposures_notional(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
    ...
    def plot_strategy_net_exposures_notional(  # noqa: D102
        self,
        strip: str | None = None,
        silent_plot: bool = False,
        reduce_plot: bool = True,
...
class PortfolioWeightConstruction:
    ...
    def __init__(self, br=None):  # noqa: D107
        self._br = br
        self._risk_engine = RiskEngine()
        self._calculations = Calculations()

    def optimize_portfolio_weights(  # noqa: D102
