...
class MarketConstants:
    ...
    backtest_thread_no = {"linux": 8, "windows": 1, "mac": 8}  # noqa: RUF012
    ...
    currencies_with_365_basis = ["AUD", "CAD", "GBP", "NZD"]  # noqa: RUF012

    # Whether to output additional fields related to calculation of total return indices
    output_calculation_fields = False

    ### FX Forwards ########################################################################################################  # noqa: E501
    fx_forwards_points_divisor_1 = ["IDR"]  # noqa: RUF012
    fx_forwards_points_divisor_100 = ["JPY"]  # noqa: RUF012
    fx_forwards_points_divisor_1000 = []  # noqa: RUF012

    # Forwards typically used for interpolation (note: eg. TN and SN are swaps)
    fx_forwards_tenor_for_interpolation = ["1W", "2W", "3W", "1M", "2M", "3M", "4M", "6M", "9M", "1Y", "2Y", "3Y", "5Y"]  # noqa: RUF012
    ...
    ### FX Options ########################################################################################################  # noqa: E501
    fx_options_points_divisor_100 = ["JPY"]  # noqa: RUF012
    fx_options_points_divisor_1000 = []  # noqa: RUF012

    # Option tenors typically used for interpolation (note: eg. TN and SN are swaps)
    fx_options_tenor_for_interpolation = [  # noqa: RUF012
        "ON",
        "1W",
        "2W",
        "3W",
