...
class VolStats:
    ...
    def __init__(self, market_df=None, intraday_spot_df=None):  # noqa: D107
    ...
    def calculate_vol_risk_premium(
        ...
        vrp[asset + "VRP" + tenor_label + ".close"] = (
            vrp[asset + "U" + tenor_label + "." + field] - vrp[asset + "H" + tenor_label + "." + field]
        )
    ...
    def calculate_implied_vol_addon(
        self,
        asset,
        implied_vol=None,
        tenor_label="ON",
        ...
        # vol_data_avg_by_weekday = vol_data.groupby(vol_data.index.weekday).transform(lambda x: pandas.rolling_mean(x, window=10))  # noqa: E501
        ...
        if model_algo == "weighted-median-model":
            vol_data_20D_avg = self._calculations.rolling_median(implied_vol, model_window)  # noqa: N806
            vol_data_10D_avg = self._calculations.rolling_median(implied_vol, model_window)  # noqa: N806
            vol_data_5D_avg = self._calculations.rolling_median(implied_vol, model_window)  # noqa: N806
            ...
            vol_data_20D_avg = self._calculations.rolling_average(implied_vol, model_window)  # noqa: N806
            vol_data_10D_avg = self._calculations.rolling_average(implied_vol, model_window)  # noqa: N806
            vol_data_5D_avg = self._calculations.rolling_average(implied_vol, model_window)  # noqa: N806
    ...
    def adjust_implied_ON_fri_vol(self, data_frame):  # noqa: D102, N802
