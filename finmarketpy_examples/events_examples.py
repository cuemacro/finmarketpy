...
# download recent NFP times and do event study for USD/JPY (using
# Bloomberg data)
if run_example == 1 or run_example == 0:
    ...
    # Need same timezone for event times as market data (otherwise can cause
    ...
    # Plot in shades of blue (so earlier releases are lighter, later releases
    # are darker)
    style.color = "Blues"
    style.color_2 = []
